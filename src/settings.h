...
struct Settings {
    ...
    uint32_t shots_since_clean;  // shots since the last cleaning cycle, persisted to NVS
    uint16_t clean_interval;     // shots between cleaning cycles; settings-menu item
