 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --font tools/fonts/Montserrat-Bold-700.ttf --format lvgl --bpp 4 --size 72 --range 0x20,0x2D,0x2E,0x30-0x39,0x43,0x67,0x73,0xB0 --no-compress -o src/fonts/lv_font_lm72_bold.c
 ******************************************************************************/
...
#ifndef LV_FONT_LM72_BOLD
#define LV_FONT_LM72_BOLD 1
#endif

#if LV_FONT_LM72_BOLD
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xff, 0xfe, 0x0, 0x7, 0xff, 0xff, 0xff, 0xa0,
    ...
    0xff, 0xff, 0x70, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x7, 0xff, 0xff, 0xf9, 0x9f, 0xff, 0xff, 0x50,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x5, 0xff, 0xff,
    0xfa, 0x9f, 0xff, 0xff, 0x60, 0x0, 0x0, 0x0,
    ...
    0x0, 0x6f, 0xff, 0xff, 0xf1, 0xb, 0xff, 0xff,
    0xff, 0x40, 0x0, 0x0, 0x0, 0x3, 0xff, 0xff,
    0xff, 0xb0, 0x3, 0xff, 0xff, 0xff, 0xf7, 0x0,
    0x0, 0x0, 0x7f, 0xff, 0xff, 0xff, 0x30, 0x0,
    0x9f, 0xff, 0xff, 0xff, 0xfa, 0x88, 0xae, 0xff,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 99, .adv_w = 302, .box_w = 15, .box_h = 15, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 212, .adv_w = 782, .box_w = 45, .box_h = 52, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 1382, .adv_w = 452, .box_w = 23, .box_h = 50, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1957, .adv_w = 680, .box_w = 41, .box_h = 51, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3003, .adv_w = 682, .box_w = 42, .box_h = 52, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 4095, .adv_w = 794, .box_w = 47, .box_h = 50, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 5270, .adv_w = 685, .box_w = 41, .box_h = 52, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 6336, .adv_w = 734, .box_w = 43, .box_h = 52, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 7454, .adv_w = 714, .box_w = 42, .box_h = 50, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 8504, .adv_w = 760, .box_w = 43, .box_h = 52, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 9622, .adv_w = 734, .box_w = 43, .box_h = 52, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 10740, .adv_w = 834, .box_w = 49, .box_h = 52, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 12014, .adv_w = 806, .box_w = 44, .box_h = 54, .ofs_x = 2, .ofs_y = -15},
    {.bitmap_index = 13202, .adv_w = 612, .box_w = 36, .box_h = 40, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 13922, .adv_w = 482, .box_w = 26, .box_h = 25, .ofs_x = 2, .ofs_y = 26}
};
...
static const uint16_t unicode_list_0[] = {
    ...
    0x15, 0x16, 0x17, 0x18, 0x19, 0x23, 0x47, 0x53,
    0x90
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_lm72_bold = {
#else
lv_font_t lv_font_lm72_bold = {
#endif
